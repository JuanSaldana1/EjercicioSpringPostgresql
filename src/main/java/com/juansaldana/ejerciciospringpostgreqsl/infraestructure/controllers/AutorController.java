...
public class AutorController {
    ...
    // Editar autor por id
    @PutMapping(path = "/modifyAutor/{id}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Autor> modifyAutorById(@PathVariable Integer id, @RequestBody Autor newAutor) {
